...
export const saveAddress = async(data: {doorNo:String, street:String, city:String, state:String, country:String },token:String | null)=>{ 
...
export const getAddress = async(data: {doorNo:String, street:String, city:String, state:String, country:String },token:string | null)=>{ 

...
import { useRouter } from 'next/navigation';
 ...
 const Content = ()=>{
    ...
    return(
      <div>
      <main>
        <h2 className={styles.headertext3}>Hello User<span>{details.firstName}</span></h2><br/>
        ...
        <div className={styles.align}>
          <div className={styles.input}>                       
           <Input placeholder="FirstName" onChange={handleChange} value={details.firstName} name='firstName' required/>
           </div>
          ...
          <div className={styles.input}>
           ...
           <div className={styles.input}>          
           <Input placeholder="Gender" type='text' onChange={handleChange} value={details.gender} name='gender' required/>
           </div>
  
           <div className={styles.input}>
           <Input placeholder="PhoneNumber" type='number' onChange={handleChange} value={details.phoneNumber} name='phoneNumber' required/>
           </div>
           ...
           <Button type='primary' danger className='ml-profile font-serif h-button text-base' onClick={()=>setIsPopupVisible(true)}>Remove Account</Button>
         </div>

      </main>
      <DeleteUser trigger={isPopupVisible}>
      <h2 className={styles.headertext4}>Are you Sure</h2><br/><br/>
      <Button onClick={success} type='primary' danger className={styles.yes}>Yes</Button>
      <Button onClick={()=> setIsPopupVisible(false)} type='primary' danger className={styles.no}>No</Button>
    </DeleteUser>
    </div>
    )
  }

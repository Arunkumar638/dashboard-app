...
import nodeTopicList from '../../Content/Node.json';
import LoadNodeContent from '../LoadNodeContent';
...
const ReactPage: React.FC = () => {
  ...
  const defaultId = 'nodejs_introduction';
    ...
    <Layout>
      ...
      >
        ...
        <Menu
          ...
          theme='dark'
          defaultSelectedKeys={['nodejs_introduction']}
          style={{ height: '840px' }}
      ...
      <Layout className=' bg-gradient-to-r from-orange to-coral'>
        ...
        >
          {defaultmode && <LoadNodeContent id={defaultId} />}
          {!!id && <LoadNodeContent id={id} />}
        </Card>
      </Layout>
    </Layout>
  );

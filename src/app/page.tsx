...
useEffect(() => {
  ...
  return (
    ...
    <div className={styles.body}>
       ...
       <Search placeholder="What do you want to learn" /*onSearch={onSearch}*/ 
       size="large" 
       type="primary" 
       allowClear 
       ...
       <Profilecard isOpen={isProfileCardOpen} onClose={handleToggleProfileCard}/>
        ...
        <Row>
          <Col>
            ...
            <Checkbox onChange={onChange} className={styles.options}><span className='mr-8'>Beginner</span></Checkbox><br/>
            <Checkbox onChange={onChange} className={styles.options}><span className='mr-8'>Intermediate</span></Checkbox><br/>
            <Checkbox onChange={onChange} className={styles.options}><span className='mr-8'>Advanced</span></Checkbox><br/>
            </Col>
            <Col className="pr-16">
            <Card hoverable 
              ...
              skills by taking up this beginner 
              course</span><br/><br/>
            ...
            <Card hoverable 
              ...
              <span className={styles.cardDescription}>
                Master your react fundamentals<br/>
                for creating more powerful web<br/>
                apps by using this course</span><br/><br/>
              <span className={styles.cardListHead}>Applications</span>
              <span className={styles.cardList}>            
              <ol className="list-disc ml-7">
          ...
          <Col>
            <Card hoverable 
              ...
              <span className={styles.cardDescription}>
                Learn Java programming through<br/> 
                examples for absolute beginner<br/>  
                and obtain core Java skills!</span><br/><br/>
              <span className={styles.cardListHead}>Applications</span>
              <span className={styles.cardList}>            
              <ol className="list-disc ml-7">
